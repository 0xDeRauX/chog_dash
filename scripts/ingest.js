...
const { mentionRows, priceRows, tvlRows, discordRows } = ingestAll();
console.log(
  `Ingested ${mentionRows} mention rows, ${priceRows} price rows, ${tvlRows} TVL rows, ${discordRows} Discord rows.`
);
